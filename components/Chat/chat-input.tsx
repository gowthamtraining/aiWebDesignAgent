...
const ChatInput = ({
    ...
    const { isSignedIn: sdkIsSignedIn } = useAuth()
    const [showAuthBanner, setShowAuthBanner] = useState(false)

    useEffect(() => {
        const manualIsSignedIn = !!localStorage.getItem("insforge-session");
        if (sdkIsSignedIn || manualIsSignedIn) {
      ...
      animate-in fade-in slide-in-from-bottom-2 duration-200"
                >
                    ...
                    <ItemContent>
                        ...
                        <ItemDescription>
                            Create an account to start designing with Forge.
                        </ItemDescription>
                    </ItemContent>
                    <ItemActions>
                        <SignInButton>

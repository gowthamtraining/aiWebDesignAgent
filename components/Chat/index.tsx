...
const ChatInterface = ({
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background">
      {/* Left sidebar */}
      <div className="flex flex-col w-full max-w-[360px] border-r border-border bg-background shrink-0">
        {/* Header */}
        <div className="flex items-center gap-2 px-3 py-2.5 border-b border-border shrink-0">
          ...
          <h5 className="flex-1 text-sm font-medium truncate text-foreground min-w-0">
